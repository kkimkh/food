            ...
            <div class = "service">
                <div class = "contents1" style="/* width:50px; */"> 
                    <!-- <a href="opgg2.html" target="blank"> -->
                        <img src="./images/서울경기1.png"width="550px" height="570px">
                    <!-- </a> -->
                ...
                <div class = "contents1">
                    ...
                    <br>
                    <h1 style="text-align: center; position: static;">&nbsp;&nbsp;&nbsp;[경기도 의정부] 부대찌개</h1>
                    <br>
                    <br>
                    ...
                    <br>
                    <div id = click>
                        <button id = "button1" type="button" onclick="location.href='jang.jsp'" style="width: 150px; top: 500px; left: 750px; background-color:#3c898d;">장바구니</button>
                        ...
                        <script> 
                        	function "location.href='jang.jsp'"(){
